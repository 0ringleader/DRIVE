...
# Paths
input_dir = "/home/terrox/Documents/johnnysCode/Alex-ai/datensatz-eddie-me/total/"
csv_path = "/home/terrox/Documents/johnnysCode/Alex-ai/datensatz-eddie-me/total.csv"
...
history = model.fit(X_train, y_train, epochs=epochs, batch_size=batch_size, validation_data=(X_val, y_val), callbacks=[checkpoint], verbose=1)
