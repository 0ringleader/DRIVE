...
model_path = "/home/terrox/Documents/johnnysCode/Alex-ai/working-model.keras"
...
def preprocess_image(image):
    processor = ImageProcessor(x_size=640, y_size=480)  # Adjust x_size, y_size based on your setup
...
def process_image_and_control(image, model):
    ...
    steering_angle *= 150.0  # Assuming the original angle range is [-100, 100]
